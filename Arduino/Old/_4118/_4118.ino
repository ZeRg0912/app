...
unsigned int NB_CNTR=0x008, R_CNTR = 0x00A;         // B=109 A=14 (850)   B=8B A=02 (445)// B=103 A=0C (830)
byte NA_CNTR=0x00, CURS1=0x00, CURS2=0x00, MUX = 0x01, CMOS=0x03, PRESC = 0x02; 
