...
void read_all (void) {
  ...
  for (i = size_start; i < size_write; i++) {
    read_loop();
    value_adress++;
    if ((dat == 0) & (data[0] == 1) & (data[1] == 0) & (data[2] == 1) & (data[3] == 0) & (data[4] == 1) & (data[5] == 0) & (data[6] == 1) & (data[7] == 0)) {      
      check++;
    }
    else if ((dat == 1) & (data[0] == 0) & (data[1] == 1) & (data[2] == 0) & (data[3] == 1) & (data[4] == 0) & (data[5] == 1) & (data[6] == 0) & (data[7] == 1)){
      check++;
    }
    else{      
    }
