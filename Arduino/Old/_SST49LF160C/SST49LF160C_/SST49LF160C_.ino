...
long size_write = 0x10000;
long size_start = 0x00;
long check = 0x0;

char serial_data = 0;
char serial_data_status = 0;
char serial_data_acess = 0;
long adress_all = 0;
char adress_p1 = 0;
char adress_p2 = 0;
char adress_p3 = 0;
...
void erase_suspend_flow (void) {
  // Write B0h in 1E0000h
  DDRD = B11111100;
  DDRB = B11111111; 
  //////////////////////    START
  lad3_0;
...
void read_acess (void) {
  ...
  bitWrite(serial_data_acess, 7, data[7]);
  bitWrite(serial_data_acess, 6, data[6]);
  bitWrite(serial_data_acess, 5, data[5]);
  bitWrite(serial_data_acess, 4, data[4]);
  //////////////////////    D7...D4
  lclk1;
  lclk0;
  ...
  bitWrite(serial_data_acess, 3, data[3]);
  bitWrite(serial_data_acess, 2, data[2]);
  bitWrite(serial_data_acess, 1, data[1]);
  bitWrite(serial_data_acess, 0, data[0]);  
  //////////////////////    TAR0
  lclk1;
  lclk0;
  //////////////////////    TAR1
  lclk1;
  lclk0;
  Serial.print(serial_data_acess);
}
...
void read_status (void) {  
  ...
  data[6] = bitRead(PINB, 1);
  data[7] = bitRead(PINB, 2);
  bitWrite(serial_data_status, 7, data[7]);
  bitWrite(serial_data_status, 6, data[6]);
  bitWrite(serial_data_status, 5, data[5]);
  bitWrite(serial_data_status, 4, data[4]);
  //////////////////////    D7...D4
  lclk1;
  lclk0;
  data[0] = bitRead(PIND, 7);
  ...
  data[2] = bitRead(PINB, 1);
  data[3] = bitRead(PINB, 2);
  bitWrite(serial_data_status, 3, data[3]);
  bitWrite(serial_data_status, 2, data[2]);
  bitWrite(serial_data_status, 1, data[1]);
  bitWrite(serial_data_status, 0, data[0]);  
  //////////////////////    TAR0
  lclk1;
  lclk0;
  //////////////////////    TAR1
  lclk1;
  lclk0;
    Serial.print(serial_data_status);
}
...
void read_loop (void) {
  ...
  //////////////////////    A19-A0
  value = value_adress;
  adress_all = value_adress;
  adress_p1 = adress_all;
  adress_p2 = (adress_all >> 8);
  adress_p3 = (adress_all >> 16);
  ...
  lclk1;
  lclk0;
//  if ((serial_data != PP) & (serial_data != AA)) {
...
void write_loop (void) {
  ...
  if ((dat == 1) & (reverse == 0)) {
    ...
    else if ((dat == 0) & (reverse == 0)){
      write_55();
    }
      else if ((dat == 1) & (reverse == 1)){
        write_55();
      }
        else if ((dat == 0) & (reverse == 1)){
          write_AA();
        }
  //////////////////////    TAR0
  lad3_1;
...
void read_all (void) {
  ...
  for (i = size_start; i < size_write; i++) {
    read_loop();
    value_adress++;
    if ((reverse == 0) & (dat == 1) & (data[0] == 1) & (data[1] == 0) & (data[2] == 1) & (data[3] == 0) & (data[4] == 1) & (data[5] == 0) & (data[6] == 1) & (data[7] == 0)) {      
      check++;
    }
      else if ((reverse == 0) & (dat == 0) & (data[0] == 0) & (data[1] == 1) & (data[2] == 0) & (data[3] == 1) & (data[4] == 0) & (data[5] == 1) & (data[6] == 0) & (data[7] == 1)){
        check++;
      }
        else if ((reverse == 1) & (dat == 1) & (data[0] == 0) & (data[1] == 1) & (data[2] == 0) & (data[3] == 1) & (data[4] == 0) & (data[5] == 1) & (data[6] == 0) & (data[7] == 1)){ 
          check++;     
        }
          else if ((reverse == 1) & (dat == 0) & (data[0] == 1) & (data[1] == 0) & (data[2] == 1) & (data[3] == 0) & (data[4] == 1) & (data[5] == 0) & (data[6] == 1) & (data[7] == 0)){ 
            check++;     
          }
            else{
            }
  ...
  if (check > ((size_write + size_write) - 1)){
    led1;
  }
  else{
    led0;
