...
#define ce0 digitalWrite(3,LOW)
#define ce1 digitalWrite(3,HIGH)
#define led0 digitalWrite(13,LOW)
#define led1 digitalWrite(13,HIGH)
#define _0 false
#define _1 true

unsigned int NB_CNTR=0x004, R_CNTR = 0x003;         // B=8D A=12 (453)   B=8B A=02 (445)
byte  NA_CNTR=0x00, CURS1=0x00, CURS2=0x00, MUX = 0x01, CMOS=0x03, PRESC = 0x00;   // MUX = 0x02 - n div //
