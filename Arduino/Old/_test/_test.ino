...
unsigned int NB_CNTR=0x008D, R_CNTR = 0x00C8;         // B=8D A=12 (453)   B=8B A=02 (445)
byte  NA_CNTR=0x12, CURS1=0x00, CURS2=0x00, MUX = 0x04, CMOS=0x03, PRESC = 0x02;   // MUX = 0x02 - n div //
