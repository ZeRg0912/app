...
unsigned long R_DIV = 0xC8; //0x02 for 200MHz = 100 MHz PFD
unsigned long N_INT_DIV = 0x64;// 0x1E for 3GHz = 100 MHz PFD
unsigned long N_FRAC_DIV = 0x00;
unsigned long GPO_SEL = 0x0A;// 0x09 - REF_DIV || 0x0A - N_DIV || 0x01 - LD
...
unsigned long ANALOG_EN = 0xC1BEFF; // 0xC1BEFF - divider /2 OFF | 0xC9BEFF - divider /2 ON
