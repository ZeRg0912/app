...
unsigned int NB_CNTR=0x0103, R_CNTR = 0x0064;         // B=109 A=14 (850)   B=8B A=02 (445)// B=103 A=0C (830)
byte  NA_CNTR=0x0C, CURS1=0x00, CURS2=0x00, MUX = 0x04, CMOS=0x03, PRESC = 0x02; 
...
//======== N register==========
   ...
   valu = (valu << 1);  // shift next bit into MSB..
   clk1;   
   clk0;  
   } 
   //////NA_CNTR 5 bit////////  
