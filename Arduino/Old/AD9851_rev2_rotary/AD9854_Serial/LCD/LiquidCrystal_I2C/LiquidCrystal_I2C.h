 ...
 */
void LCD_I2C(uint8_t lcd_addr, uint8_t lcd_cols, uint8_t lcd_rows, uint8_t charsize = LCD_5x8DOTS);
...
inline void LCD_blink_on() { blink(); }
inline void LCD_blink_off() { noBlink(); }
inline void LCD_cursor_on() { cursor(); }
inline void LCD_cursor_off() { noCursor(); }
